...
for i in range(FOLD):
    ...
    model, history = train_with_sgd(model, X_train, Y_train, X_test, Y_test, learning_rate = 0.05, nepoch = 100, evaluate_loss_after = 1)
...
model, history = train_with_sgd(model, array_X, Y, array_X_test, Y_test_full, learning_rate = 0.05, nepoch = 100, evaluate_loss_after = 1)
