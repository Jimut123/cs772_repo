...
class RNNNumpy():
    def __init__(self, word_dim, hidden_dim = 1, bptt_truncate = 4):
        ...
        # random initiate the parameters - version - 2
        self.I = np.random.uniform(-10, 10, (hidden_dim, word_dim)) #WEIGHT FROM CURRENT INPUT TO HIDDEN
        self.H = np.random.uniform(-10, 10, (hidden_dim, hidden_dim)) #WEIGHT FROM PREVIOUS STATE TO NEXT STATE
        self.S = np.random.uniform(-10, 10, (hidden_dim,word_dim+1)) #WEIGHT FROM PREVIOUS INPUT TO CURRENT HIDDEN
